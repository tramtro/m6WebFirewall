<?php
namespace nguyenanhung\Component\Firewall;

use InvalidArgumentException as InvalidArgumentExceptionAlias;
use nguyenanhung\Component\Firewall\Entry\EntryFactory;
use nguyenanhung\Component\Firewall\Lists\ListMerger;
...
class Firewall
{
    ...
    {
        if (!is_bool($state)) {
            throw new InvalidArgumentExceptionAlias("Wrong parameter 'state' is not boolean");
        }
